...
import CustomerItemBadges from "@/components/customer/items/list/CustomerItemBadges.tsx";
import NotesBadge from "@/components/NotesBadge.tsx";
import CustomerItemMSRP from "@/components/customer/items/list/CustomerItemMSRP.tsx";

export const getCustomerColumns = (customer: BarcodeCustomerSettings | null) => {
    const fields: DataTableField<BarcodeItem>[] = [];
